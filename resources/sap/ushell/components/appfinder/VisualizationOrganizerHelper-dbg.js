...
sap.ui.define([
    ...
    function VisualizationOrganizerHelper () {
         ...
         * @param {sap.ui.base.Event} oEvent The press event.
         *
         * @returns {Promise<boolean>} A promise return true if pin button status should be updated
         *
         * @since 1.84.1
         * @protected
         */
         ...
         * @protected
         */
        this.formatBookmarkPinButtonTooltip = function (aGroupsIDs, bookmarkCount, sGroupContextModelPath, sGroupContextId, sGroupContextTitle) {
            if (!isSpacesEnabled()) {
                return this.formatPinButtonTooltip(aGroupsIDs, bookmarkCount, sGroupContextModelPath, sGroupContextId, sGroupContextTitle);
            }
            return oVisualizationOrganizer.formatBookmarkPinButtonTooltip(bookmarkCount, oSectionContext);
        };
