    ...
    return Controller.extend("sap.ushell.components.shell.Settings.userLanguageRegion.LanguageRegionSelector", {
        onInit: function () {
            ...
            if (bIsEnableSetUserPreference) {
                ...
                sNumberFormat = oFormatSetting.getLegacyNumberFormat();
            ...
            if (bUpdateLanguage || bIsEnableSetUserProfileSetting) {
                ...
                return new Promise(function (resolve, reject) {
                    ...
                    if (bIsEnableSetUserProfileSetting) {
                        ...
                        if (oFormatSetting.getLegacyNumberFormat() !== oModelData.selectedNumberformat) {
                            oUser.setChangedProperties({
                                propertyName: "numberFormat",
                                name: "NUMBER_FORMAT"
                            }, oFormatSetting.getLegacyNumberFormat(), oModelData.selectedNumberformat);
                        }
                    ...
                    this.userInfoService.updateUserPreferences(oUser)
                        ...
                        .fail(function (sErrorMessage) {
                            ...
                            Log.error("Failed to save Language and Region Settings", sErrorMessage,
                                "sap.ushell.components.ushell.settings.userLanguageRegion.LanguageRegionSelector.controller");
        ...
        _restoreUserSettingPreferenceValues: function () {
            ...
            oModel.setProperty("/selectedNumberformat", oFormatSetting.getLegacyNumberFormat());
