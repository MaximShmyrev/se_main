...
sap.ui.define([
    ...
    utils.invokeUnfoldingArrayArguments = function (fnFunction, aArguments) {
        ...
        aArgArray.forEach(function (nThArgs, iIndex) {
            if (!Array.isArray(nThArgs)) {
                Log.error("Expected Array as nTh Argument of multivalue invokation: first Argument must be array of array of arguments: single valued f(p1,p2), f(p1_2,p2_2), f(p1_3,p2_3) : multivalued : f([[p1,p2],[p1_2,p2_2],[p1_3,p2_3]]");
     ...
     *
     * @returns {boolean}
     *    Whether the given intent is the FLP home intent.
     *
     * @throws {Error}
     *    When a wrong input parameter is given.
     *
    ...
    utils.isFlpHomeIntent = function (sIntent) {
        ...
        // validate configured intent
        var sIntentNoHash = sIntent.replace("#", "");
        return sIntentNoHash === "Shell-home" || sIntentNoHash.indexOf("Launchpad-openFLPPage") === 0;
    };
