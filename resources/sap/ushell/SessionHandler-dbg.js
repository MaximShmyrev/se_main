...
sap.ui.define([
    ...
    var SessionHandler = function (AppLifeCycle) {
        ...
        this.initSessionTimeout = function () {
            jQuery.sap.measure.start("SessionTimeoutInit", "Initialize Session Timeout", "FLP_SHELL");
        ...
        this.monitorUserIsInactive = function () {
            ...
            if (iTimeNow < iTimePopup) {
                setTimeout(this.monitorUserIsInactive.bind(this), iRemainingTimeUntilDialog * 1000);
                return;
            }
