...
sap.ui.define([
    ...
    function LaunchPageAdapter (oUnused, sParameter, oAdapterConfiguration) {
         ...
         * @private
         */
        this._visitBookmarks = function (sUrl, fnVisitor, sVizType) {
                ...
                var aTiles = Object.keys(oGroups)
                    ...
                    .map(function (sKey) {
                        return oGroups[sKey].payload.tiles.filter(function (oTile) {
                            ...
                            return oTile.isBookmark && oTile.vizType === sVizType && isSameTarget(oReferenceTarget, oTile.target);
                        });
                    })
         ...
         * @since 1.83.0
         */
        this.addCustomBookmark = function (oBookmarkConfig, oTargetGroup) {
            var oDeferred = new jQuery.Deferred();
        ...
        this.countCustomBookmarks = function (oIdentifier) {
            ...
            return new Promise(function (resolve, reject) {
                this._visitBookmarks(oIdentifier.url, undefined, oIdentifier.vizType).done(resolve).fail(reject);
            }.bind(this));
        };
         ...
         * @since 1.42.0
         */
        this.updateBookmarks = function (sUrl, oParameters, sVizType) {
            var oContainer = sap.ushell.Container;
            var oUrlParsing = oContainer.getService("URLParsing");
            var oCdmSiteService = oContainer.getService("CommonDataModel");
            ...
            return this._visitBookmarks(sUrl, updateEach, sVizType)
        ...
        this.updateCustomBookmarks = function (oIdentifier, oBookmarkConfig) {
            ...
            return new Promise(function (resolve, reject) {
                this.updateBookmarks(oIdentifier.url, oBookmarkConfig, oIdentifier.vizType).done(resolve).fail(reject);
            }.bind(this));
        };
         ...
         * @since 1.42.0
         */
        this.deleteBookmarks = function (sUrl, sVizType) {
            var oContainer = sap.ushell.Container;
            var oUrlParser = oContainer.getService("URLParsing");
            var oCDM = oContainer.getService("CommonDataModel");
            var oIntent = oUrlParser.parseShellHash(sUrl);
        ...
        this.deleteCustomBookmarks = function (oIdentifier) {
            ...
            return new Promise(function (resolve, reject) {
                this.deleteBookmarks(oIdentifier.url, oIdentifier.vizType).done(resolve).fail(reject);
            }.bind(this));
        };
