...
sap.ui.define([
...
], function (VizInstance, ushellLibrary, mobileLibrary, Component, ObjectPath, deepExtend, ComponentContainer) {
    "use strict";
    ...
    VizInstanceCdm.prototype.load = function () {
        ...
        switch (sDisplayFormat) {
            ...
            case DisplayFormat.TileWide: {
                this.setWidth(4);
                this.setHeight(2);
                break;
            }
            default: {
                var sSize = ObjectPath.get(["vizType", "sap.flp", "tileSize"], this.getInstantiationData());
                this._setSize(sSize);
            }
        }
