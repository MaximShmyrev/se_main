...
sap.ui.define([
    ...
    "sap/base/Log"
], function (EventProvider, TechnicalParameters, AppInfoParameters, Log) {
    "use strict";
    /*global hasher*/
    ...
    function AppLifeCycle (oAdapter, oContainerInterface, sParameter, oConfig) {
        ...
        /**
         * Reload the current displayed app (used by RTA plugin)
         *
         * @since 1.84
         * @private
         */
        this.reloadCurrentApp = function () {
            try {
                sap.ushell.Container.getService("ShellNavigation").hashChanger.treatHashChanged(window.hasher.getHash());
            } catch (ex) {
                Log.error(
                    "Error when trying to re-load the current displayed application",
                    ex,
