...
sap.ui.define([
    ...
    function Personalization (oAdapter, oContainerInterface, sParameter, oConfig) {
        ...
        // suitable random string provided by the backend.
        // Should be an unpredictable random value of cryptographic strength.
        this._seed = (oConfig && oConfig.config && typeof oConfig.config.seed === "string" && oConfig.config.seed)
                     || "12345678901AFERANDOMBETTER";
    ...
    Personalization.prototype.getGeneratedKey = function () {
        ...
        if (window && window.crypto && window.crypto.getRandomValues) {
            var arr40 = new window.Uint32Array(40);
