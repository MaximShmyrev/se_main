...
sap.ui.define([
    ...
    "use strict";
    var mCustomerCreatedTable = {
            id: "customerCreatedColumnPageId",
            description: "customerCreatedColumnPageId",
            title: "customerCreatedColumnPageTitle",
            createdByFullname: "customerCreatedColumnPageCreated",
            createdOn: "customerCreatedColumnPageCreated",
    ...
    return Controller.extend("sap.ushell.applications.PageComposer.controller.ViewSettingsDialogCustomerCreated", {
        ...
        handleCustomerCreatedDialogConfirm: function (oEvent) {
            ...
            this.PageOverviewController.updateSortIndicators(oParams.sortItem.getKey(), oParams.sortDescending, mCustomerCreatedTable, oTable.getColumns());
