...
sap.ui.define([
    ...
    return BaseController.extend("sap.ushell.applications.PageComposer.controller.Main", {
        ...
        /**
         * Sets the pages count to the model
         *
         * @private
         */
        _initPagesCount: function () {
            this.setModel(new JSONModel({
                pagesCountSapDelivered: 0,
                pagesCountCustomer: 0
            }));
        },
        ...
        _loadPageMasterSet: function () {
            if (!this._bPageMasterSetLoaded) {
                ...
                this.byId("sapDeliveredColumnPageId").setSortIndicator("Ascending");
            }
        },
         ...
         * @param {sap.ui.base.Event} event The onUpdateFinished event.
         * @private
         */
        onTableUpdate: function (event) {
            ...
            if (this.sCurrentTableId === "customerCreatedTable") {
                this.getModel().setProperty("/pagesCountCustomer", event.getParameter("total"));
            } else {
                this.getModel().setProperty("/pagesCountSapDelivered", event.getParameter("total"));
            }
        },
