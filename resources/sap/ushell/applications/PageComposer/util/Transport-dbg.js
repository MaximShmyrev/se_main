...
sap.ui.define([], function () {
    ...
    TransportHelper.prototype.enhanceDialogWithTransport = function (dialog, transportComponent, onConfirm) {
        ...
        this.attachConfirmHandler(dialog, transportComponent, onConfirm);
    ...
    TransportHelper.prototype.attachConfirmHandler = function (dialog, transportComponent, onConfirm) {
        dialog.attachConfirm(function (pageInfo) {
