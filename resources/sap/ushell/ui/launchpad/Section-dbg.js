...
sap.ui.define([
    ...
    function _getNearestViz (oRefItem, aViz, bAbove) {
        ...
        // measure of distance between centers of two rectangles (square of double, to spare calculaitons)
    ...
    function getDefaultAreaFilter () {
        return new Filter({
            ...
            test: function (oConfig) {
                ...
                return sDisplayFormatHint === DisplayFormat.Default
                    || sDisplayFormatHint === DisplayFormat.Tile
                    || sDisplayFormatHint === DisplayFormat.TileWide
                    || sDisplayFormatHint === DisplayFormat.Standard
                    || sDisplayFormatHint === DisplayFormat.StandardWide;
            }
        });
    }
    ...
    function getFlatAreaFilter () {
        return new Filter({
            ...
            test: function (oConfig) {
                var sDisplayFormatHint = getDisplayFormatHint(oConfig);
                return sDisplayFormatHint === DisplayFormat.Flat
                    || sDisplayFormatHint === DisplayFormat.FlatWide;
            }
        });
    }
     ...
     * @returns {integer} Index of the visualization in the model.
    */
     ...
     * @private
     */
    Section.prototype._showHideSwitchChange = function (value) {
    ...
    Section.prototype.setShowSection = function (value) {
        ...
        // in case of a new section this method gets called with value undefined
        // and afterwards called with the target value
        if (value !== undefined) {
            this.byId("showHideSwitch").setState(value);
