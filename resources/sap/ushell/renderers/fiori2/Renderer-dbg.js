...
sap.ui.define([
    ...
    Renderer.prototype.createContent = function () {
        ...
        oView.loaded().then(function (oCreatedView) {
                    ...
                    sap.ushell.Container.getRenderer("fiori2").addHeaderEndItem("sap.ushell.ui.shell.ShellHeadItem",
                        {
                            ...
                            press: function (event) {
                                WebAssistant.toggle(); // eslint-disable-line no-undef
                            }
                        },
                        true,
                        false);
                ...
                sap.ushell.Container.getService("PluginManager").registerPlugins({
                    RTAPOCPlugin: {
                        ...
                        config: {
                            ...
                            "sap-plugin-agent-id": "RTAPluginAgent"
                        }
                    }
                });
            }
     ...
     * @returns {object} jQuery.deferred.promise object that when resolved, returns the newly created control
     * @since 1.48
     * @deprecated since version 1.86. This API is for backward compatibility only. Do not use it.
     * @public
     */
