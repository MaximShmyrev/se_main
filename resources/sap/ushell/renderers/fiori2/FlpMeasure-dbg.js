 ...
 * @private
 */
sap.ui.define(["sap/ui/thirdparty/jquery", "sap/base/util/now", "sap/ushell/utils/WindowUtils"], function (jQuery, now, WindowUtils) {
    "use strict";
        ...
        this.setActive = function (bOn, aCategories) {
            ...
            document.addEventListener("keyup", function (e) {
                if (e.shiftKey && e.ctrlKey && e.altKey && e.keyCode == 77) {
                    ...
                    WindowUtils.openURL(sap.ui.require.toUrl("sap/ushell/renderers/fiori2/stat") + ".html");
                }
            }, false);
            return perfActive;
        };
