...
sap.ui.define([
    ...
    sap.ui.controller("sap.ushell.renderers.fiori2.Shell", {
        ...
        handleDataLoss: function (targetIntent, currentIntent) {
            ...
            var oParsedHash = sap.ushell.Container.getService("URLParsing").parseShellHash(targetIntent);
            ...
            if (!Device.browser.msie && !bBuiltInIntent && (this.bExplaceNavigation || sNavMode === "explace")) {
                    ...
                    if (bBuiltInIntent) {
                        ...
                        oService.resolveHashFragment(sTargetHash)
                            .then(function (oResolvedHashFragment) {
                                if (oResolvedHashFragment.navigationMode === "explace") {
        ...
        _openAppViaNWBC: function (oResolvedHashFragment) {
            ...
            this.bEnableHashChange = false;
            this._restorePreviousHashAfterOpenNewWindow(oResolvedHashFragment, true);
         ...
         * @param {boolean} [bOpenViaNWBC] flag if app was opened via BWBC
         */
        _restorePreviousHashAfterOpenNewWindow: function (oResolvedHashFragment, bOpenViaNWBC) {
            this.history.pop();
            ...
            this._resumeAppRouterIgnoringCurrentHash();
            if (this.oShellNavigation.isInitialNavigation() && bOpenViaNWBC) {
                this.bEnableHashChange = true;
                sap.ushell.Container.getServiceAsync("CrossApplicationNavigation")
                    .then(function (CrossApplicationNavigation) {
                        CrossApplicationNavigation.toExternal({ target: { shellHash: "#" }, writeHistory: false });
                    });
            } else {
                this._windowHistoryBack(1);
            }
