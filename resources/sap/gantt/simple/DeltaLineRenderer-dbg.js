...
sap.ui.define(
    ...
    function (BaseLine, BaseTriangle, BaseDeltaRectangle, Format, Parameters) {
        "use strict";
        ...
        DeltaLineRenderer.renderDeltaLineHeader = function (
            ...
            var iX1 = oAxisTimes.timeToView(
                Format.abapTimestampToDate(oDeltaLine.getTimeStamp())
            );
            var iX2 = oAxisTimes.timeToView(
                Format.abapTimestampToDate(oDeltaLine.getEndTimeStamp())
            );
            ...
            if (oGantt.getEnableDeltaLine() === false || isNaN(iX1) || isNaN(iX2)) {
                ...
                if (!oHeaderDeltaArea) {
                    ...
                    oHeaderDeltaArea.setProperty("width", iX2 - iX1, true);
		...
		DeltaLineRenderer.renderChartAreaOfDeltaLines = function (oRm, oDeltaLine, oGantt) {
			...
			if (!oChartDeltaArea) {
				...
				oChartDeltaArea.setProperty("width", iX2 - iX1 - 2, true);
