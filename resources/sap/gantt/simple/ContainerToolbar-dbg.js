sap.ui.define([
	...
	ContainerToolbar.prototype._fireSettingItemChangedEvent = function(){
		...
		if (document.getElementById(this.getId() + "-overflowButton") && document.getElementById(this.getId() + "-settingsButton").parentElement.classList.contains("sapMPopoverScroll")) {
			document.getElementById(this.getId() + "-overflowButton").focus();
		}
	};
