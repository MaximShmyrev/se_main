...
sap.ui.define([
	...
	"./GanttExtension",
	"./CoordinateUtils"
], function(jQuery, GanttExtension, CoordinateUtils) {
	"use strict";
	...
	var LassoHelper = {
		...
		addLassoEventListeners: function(oGantt) {
			...
			$document.on("mouseup" + _sNamespace, oExtension.endLasso.bind(oExtension));
	...
	GanttLassoExtension.prototype.onKeydown = function(oEvent) {
		if (this.isLassoDrawing() && oEvent.keyCode === jQuery.sap.KeyCodes.ESCAPE) {
