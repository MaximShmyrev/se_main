sap.ui.define(["sap/ui/core/mvc/Controller", "sap/ovp/cards/ActionUtils",
    ...
    "sap/ovp/app/OVPUtils", "sap/ui/events/KeyCodes", "sap/base/util/isPlainObject", "sap/base/util/merge", "sap/ovp/cards/ovpLogger", "sap/ovp/cards/jUtils", "sap/base/util/isEmptyObject", "sap/ovp/cards/Filterhelper", "sap/ui/model/odata/v4/AnnotationHelper", "sap/ui/util/openWindow"],
    function (Controller, ActionUtils, SelectionVariant, PresentationVariant,
              ...
              JSONModel, Dialog, Button, MessageToast, TextDirection, GenericAppLibrary, jQuery, OvpResources, OVPUtils, KeyCodes, isPlainObject, merge, ovpLogger, jUtils, isEmptyObject, Filterhelper, oDataAnnotationHelperV4, openWindow) {
        "use strict";
        ...
        return Controller.extend("sap.ovp.cards.v4.generic.Card", {
            ...
            setHeaderCounter: function (oItemsBinding, countHeader) {
                ...
                countHeader.addCustomData(new CustomData({
                    key: "aria-label",
                    value: countHeaderText,
                    writeToDom: true
                }));
            },
            ...
            getEntitySet: function () {
                if (!this.entitySet) {
                    ...
                    this.entitySet = this.getMetaModel().getObject("/" + sEntitySet);
                }
