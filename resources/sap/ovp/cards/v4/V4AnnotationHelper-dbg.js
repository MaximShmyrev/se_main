    ...
    function (NumberFormat, DateFormat, CommonUtils, OdataAnnotationHelper,
        ...
        function formatKPIHeaderState(iContext, oDataPoint) {
            if (oDataPoint && oDataPoint.Criticality && oDataPoint.Criticality.$Path) {
                return "{parts: [{path:'" + oDataPoint.Criticality.$Path + "'}], formatter: 'sap.ovp.cards.v4.V4AnnotationHelper.kpiValueCriticality'}";
            } else {
        ...
        function getAggregateNumber(iContext, oEntitySet, oDataPoint, oSelectionVariant) {
            ...
            var unitColumn = getUnitColumnV4(measure, properties);
            ...
            if (oDataPoint && oDataPoint.CriticalityCalculation && oDataPoint.CriticalityCalculation.DeviationRangeLowValue) {
                selectArr.push(oDataPoint.CriticalityCalculation.DeviationRangeLowValue);
            }
            if (oDataPoint && oDataPoint.CriticalityCalculation && oDataPoint.CriticalityCalculation.ToleranceRangeLowValue) {
                selectArr.push(oDataPoint.CriticalityCalculation.ToleranceRangeLowValue);
            }

            // if DeviationRangeHighValue and ToleranceRangeHighValue read from Path instead of string
            if (oDataPoint && oDataPoint.CriticalityCalculation && oDataPoint.CriticalityCalculation.DeviationRangeHighValue) {
                selectArr.push(oDataPoint.CriticalityCalculation.DeviationRangeHighValue);
            }
            if (oDataPoint && oDataPoint.CriticalityCalculation && oDataPoint.CriticalityCalculation.ToleranceRangeHighValue) {
                selectArr.push(oDataPoint.CriticalityCalculation.ToleranceRangeHighValue);
            }

            if (unitColumn) {
                selectArr.push(unitColumn);
            }
            if (oDataPoint && oDataPoint.TrendCalculation && oDataPoint.TrendCalculation.ReferenceValue) {
                selectArr.push(oDataPoint.TrendCalculation.ReferenceValue);
            }
        ...
        function formPathForPercentageChange(dataPoint) {
            ...
            if (dataPoint.TrendCalculation.ReferenceValue.$Path) {
                ...
                return "{parts: [{path:'" + dataPoint.Value.$Path + "'}], formatter: 'sap.ovp.cards.v4.V4AnnotationHelper.returnPercentageChange'}";
            }
        }
        ...
        function formPathForTargetValue(oDataPointAnnotation) {
            ...
            if (oDataPointAnnotation.TrendCalculation.ReferenceValue) {
                if (oDataPointAnnotation.TrendCalculation.ReferenceValue) {
                    ...
                    return "{parts: [{path:'" + oDataPointAnnotation.Value.$Path + "'}], formatter: 'sap.ovp.cards.v4.V4AnnotationHelper.TargetValueFormatter'}";
                }
                if (oDataPointAnnotation.TrendCalculation.ReferenceValue.$Path) {
                    ...
                    return "{parts: [{path:'" + oDataPointAnnotation.Value.$Path + "'},{path:'" + oDataPointAnnotation.TrendCalculation.ReferenceValue.$Path + "'}], formatter: 'sap.ovp.cards.v4.V4AnnotationHelper.TargetValueFormatter'}";
                }
            }
        }
