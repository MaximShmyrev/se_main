...
// end   sap/net/AuxWindowFrameProvider.js *******************************************
    ...
    function isDirectStart (sHash) {
        /*
         * Determine whether hash is a standalone hash #Shell-runStandaloneApp etc; in
         ...
         * @private
         */
        function isStandaloneHash(hash) {
            if (!hash) {
                return false;
            }
            return hash.indexOf("Shell-home") === 0
                || hash.indexOf("Shell-catalog") === 0
                || hash.indexOf("shell-catalog") === 0
                || hash.indexOf("Action-search") === 0;
        }
        /*
    ...
    function getServerConfigUrls () {
        ...
        if (typeof sHardcodedUrlOrParameterUrl !== "undefined") {
            ...
            oAllowlist = oConfig &&
                ...
                oConfig.hasOwnProperty("configurationFileFolderWhitelist") && // inclusive language FLPCOREANDUX-4020: this configuration parameter is deprecated and will be removed
                Object.prototype.toString.apply(oConfig.configurationFileFolderWhitelist) === "[object Object]" && // inclusive language FLPCOREANDUX-4020: this configuration parameter is deprecated and will be removed
                oConfig.configurationFileFolderWhitelist;// inclusive language FLPCOREANDUX-4020: this configuration parameter is deprecated and will be removed
