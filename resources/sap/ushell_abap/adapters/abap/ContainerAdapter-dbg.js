...
sap.ui.define([
    ...
    var ContainerAdapter = function (oSystem, sParameter, oProperties) {
        ...
        this.load = function () {
            ...
            oStartupResult.productName = oSystemProperties && oSystemProperties.productName;
            oStartupResult.systemName = oSystemProperties && oSystemProperties.systemName;
            oStartupResult.systemRole = oSystemProperties && oSystemProperties.systemRole;
            oStartupResult.tenantRole = oSystemProperties && oSystemProperties.tenantRole;
