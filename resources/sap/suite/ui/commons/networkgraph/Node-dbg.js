...
sap.ui.define([
	...
	Node.prototype._renderHtmlInfoIcon = function(mArguments, mOptions) {
		...
		sHtml += "<div title=\"" + oResourceBundle.getText("NETWORK_GRAPH_COLLAPSED") + "\" id=\"" + this._getElementId(mOptions.idSufix)  + "-statusiconwrapper" + "\" " + sStyle + " class=\"sapSuiteUiCommonsNetworkNodeDivInfoWrapper sapSuiteUiCommonsNetworkNodeInfoWrapper\" >";

		sHtml += "<div class=\"sapSuiteUiCommonsNetworkNodeDivInfoIcon sapSuiteUiCommonsNetworkGraphDivNodeIcon\" >";
		sHtml += this._renderHtmlIcon(sStatusIcon || "sap-icon://hint");
		sHtml += "</div>";
	...
	Node.prototype._renderHtmlContent = function(mOptions) {
		...
		if (bIsCircle) {
			...
			mOptions.renderManager.openEnd();
			mOptions.renderManager.unsafeHtml(this.renderHtmlActionButtons(mOptions));
			...
			mOptions.renderManager.openEnd();
			mOptions.renderManager.unsafeHtml(this._renderHtmlInfoIcon({}, mOptions));
			...
			mOptions.renderManager.close("div");
			mOptions.renderManager.close("div");
			mOptions.renderManager.unsafeHtml(this._renderHtmlTitleAndDescription());
		} else {
			...
			mOptions.renderManager.unsafeHtml(this._renderHtmlTitleIcon("sapSuiteUiCommonsNetworkGraphDivNodeIconTitle"));
			mOptions.renderManager.unsafeHtml(this._renderHtmlTitle(sContentColor));
			mOptions.renderManager.close("div");
