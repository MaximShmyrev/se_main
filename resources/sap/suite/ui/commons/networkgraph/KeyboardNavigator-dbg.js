...
sap.ui.define([
...
], function (jQuery, BaseObject, Group, Node, Line, KeyCodes, containsOrEquals, Log, F6Navigation) {
	"use strict";
	...
	KeyboardNavigator.prototype.onsapskipforward = function(oEvent) {
		oEvent.preventDefault();
		this._handleGroupNavigation(oEvent, false);
	};

	KeyboardNavigator.prototype.onsapskipback = function(oEvent) {
		oEvent.preventDefault();
	 ...
	 * @private
	 */
	KeyboardNavigator.prototype._handleGroupNavigation = function(oEvent, bShiftKey) {
		var oEventF6 = jQuery.Event("keydown");
		var oFocus = this.getFocus();

		// Prevent the event and focus Graph control
		oEvent.preventDefault();
