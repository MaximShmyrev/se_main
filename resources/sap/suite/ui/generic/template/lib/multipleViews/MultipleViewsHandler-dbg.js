sap.ui.define([
...
], function(BaseObject, Filter, MultipleTablesModeHelper, SingleTableModeHelper, SelectionVariant, controlHelper, metadataAnalyser, FeLogger, testableHelper, extend, encodeURL, DateTimeUtil, isEmptyObject) {
	"use strict";
	...
	function getMethods(oController, oTemplateUtils, oConfiguration) {
		...
		function fnRefreshOperationOnCurrentSmartControl(iRequest){
			var oCurrentViewMeta = fnGetCurrentViewMeta();
			var bIsSmartTable = controlHelper.isSmartTable(oCurrentViewMeta.smartControl);
