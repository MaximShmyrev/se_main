sap.ui.define(["sap/ui/model/odata/AnnotationHelper",
	...
	"sap/ui/Device",
	"sap/m/library"
], function (AnnotationHelperModel, SmartField, FeLogger, formatMessage, deepExtend, encodeXML, RuntimeFormatters, StableIdHelper, testableHelper, Device, SapMLibrary) {
	"use strict";
...
*/
		...
		getMetaModelBinding: function(oContext){
			...
			return oMetaModel.createBindingContext(sMetaModelPath);
		},
