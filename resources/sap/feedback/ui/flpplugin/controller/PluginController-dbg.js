...
sap.ui.define(["sap/ui/base/Object", "../utils/Constants", "./ContextDataController", "./PushClient",
		"../ui/ShellBarButton",
		"../ui/PopOverVisual", "../ui/IFrameVisual", "./WebAppFeedbackLoader"
	],
			...
			_onPushCallback: function (oEventData) {
				return new Promise(function (
					...
					if (this._oWebAppFeedbackLoader.getIsAPILoaded()) {
						this._oContextDataController.updateContextData(Constants.E_INTERCEPT_ID.push).then(function () {
							this._oContextDataController.setPushContextData(oEventData);
							QSI.API.unload();
