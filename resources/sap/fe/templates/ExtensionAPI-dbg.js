...
sap.ui.define(
	...
	function(BaseObject, CommonUtils, DelegateUtil, Log, Component, BusyLocker) {
		"use strict";
		...
		var extensionAPI = BaseObject.extend("sap.fe.templates.ExtensionAPI", {
			...
			navigateToTarget: function(sTarget, oContext) {
				this._controller.routing.navigateToTarget(oContext, sTarget);
			},
			...
			intentBasedNavigation: {
				...
				navigateOutbound: function(sOutbound, mNavigationParameters) {
					...
					this._controller.intentBasedNavigation.navigateOutbound(sOutbound, mNavigationParameters);
				}
			}
		});
