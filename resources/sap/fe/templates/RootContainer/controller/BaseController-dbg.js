sap.ui.define(
	...
	function(JSONModel, FEController, Component, HashChanger, CommonUtils, SizeHelper, AnnotationHelper, BindingParser, Log, Placeholder) {
		"use strict";

		return FEController.extend("sap.fe.templates.RootContainer.controller.BaseController", {
			...
			onContextBoundToView: function(oContext) {
				if (oContext) {
					...
					if (!sDeepestPath || sDeepestPath.indexOf(sViewContextPath) !== 0) {
						...
						this.getView()
							.getModel("internal")
							.setProperty("/deepestPath", sViewContextPath);
					}
				}
			},
