...
sap.ui.define(
	...
	function(
		...
		return FEController.extend("sap.fe.templates.ObjectPage.ObjectPageController", {
			metadata: {
				methods: {
					getExtensionAPI: {
						"public": true,
			...
			_onBeforeBinding: function(oContext, mParameters) {
				...
				var oDelegateOnBefore = {
					onBeforeRendering: fnScrollToPresentSection
				};
			...
			_onPasteTableButtonPressed: function(oTable) {
				...
				if (sDeviceBrowser.mobile) {
					...
					switch (sDeviceOs) {
						case "win":
							sMessageOnPasteButton = oResourceModel.getText(
