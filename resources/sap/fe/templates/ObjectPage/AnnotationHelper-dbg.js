...
sap.ui.define(
	 ...
	 */
		...
		var AnnotationHelper = {
			 ...
			 */
			getButtonVisiblityForDeleteHidden: function(oDeleteHidden) {
				if (oDeleteHidden) {
			...
			getDeleteButtonVisibility: function(oDeletable, viewLevel, oDeleteHidden, bParentDeleteRestrictionEnabled) {
				...
				if (viewLevel > 1) {
					return AnnotationHelper.getButtonVisiblityForDeleteHidden(oDeleteHidden);
			 ...
			 * @returns {string} Returns expression binding or boolean value based on oDeleteHidden, viewLevel.
			 */
			getDeleteCommandExecutionVisible: function(oDeletable, viewLevel, oDeleteHidden, aConverterContextHeaderActions) {
				var oDeleteAction = aConverterContextHeaderActions.find(function(oAction) {
					return oAction.type === "Secondary";
				});
				return this.getDeleteButtonVisibility(oDeletable, viewLevel, oDeleteHidden, oDeleteAction.parentEntityDeleteEnabled);
			},
			/**
