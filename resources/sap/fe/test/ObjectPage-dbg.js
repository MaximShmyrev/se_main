sap.ui.define(
	...
	function(
		...
		function getTableValueHelpId(sNavProperty, sPropertyId) {
			return getTableId(sNavProperty) + "::TableValueHelp::" + sPropertyId.split("/").join("::");
		}
					...
					ViewId,
					{
						actions: {
							...
							iOpenVHDialog: function(oField) {
								var sFieldId = getFieldId(oField) + "-edit-inner-vhi";
								return OpaBuilder.create(this)
									.hasId(sFieldId)
									.doPress()
							...
							iConfirmTableVHD: function(sTableName, sFieldName) {
								var sTableVHDId = getTableValueHelpId(sTableName, sFieldName);
								var oResult = OpaBuilder.create(this)
									.hasId(sTableVHDId + "-ok")
									.doPress()
						...
						assertions: {
							...
							iSeeMessageItem: function(oMessageInfo) {
								return OpaBuilder.create(this)
									.hasType("sap.m.MessageListItem")
									.hasProperties({
										title: oMessageInfo.MessageText,
