...
import { FacetTypes, ReferenceFacetTypes } from "@sap-ux/vocabularies-types";
...
export type ManifestWrapper = {
	 ...
	 */
	getFormContainer(facetDefinition: FacetTypes): FormManifestConfiguration;
	/**
...
export function createManifestWrapper(oManifestSettings: BaseManifestSettings, mergeFn: Function): ManifestWrapper {
	return {
		getFormContainer(facetDefinition: ReferenceFacetTypes): FormManifestConfiguration {
			return oManifestSettings.controlConfiguration?.[facetDefinition.Target.value] as FormManifestConfiguration;
		},
		getHeaderFacets(): ConfigurableRecord<ManifestHeaderFacet> {
			return mergeFn(
				{},
