	...
	function(ODataModelAnnotationHelper, CommonHelper) {
		...
		var FormHelper = {
			...
			dataFieldCollectionContainsMoreThanActionOrIBN: function(aDataFields) {
				if (!Array.isArray(aDataFields) && aDataFields.$Type) {
					return true;
				}
			 ...
			 * @returns {boolean} true if annotation path is not of type line item,presentation variant and chart false otherwise(a datafield)
			 */
