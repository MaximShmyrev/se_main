...
sap.ui.define(
	...
	function(Filter, NumberFormat, CommonUtils, FilterUtils, ChartUtils, Log, DelegateUtil) {
		"use strict";
		...
		function getFilterInfo(oTable) {
			return FilterUtils.getFilterInfo(oTable.getFilter(), undefined, oTable.data("targetCollectionName"));
		}
