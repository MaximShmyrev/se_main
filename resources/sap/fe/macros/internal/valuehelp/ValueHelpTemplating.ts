...
export const shouldShowConditionPanel = function(oDataModelPath: DataModelObjectPath) {
	return checkFilterExpressionRestrictions(oDataModelPath, ["SingleValue", "MultiValue"]);
};
