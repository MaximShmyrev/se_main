...
sap.ui.define(
	...
	function(MacroMetadata, ListReportConverter, ConverterContext, TemplateModel, BaseConverter, merge) {
		"use strict";
		...
		var FilterBar = MacroMetadata.extend("sap.fe.macros.valuehelp.ValueHelpFilterBar", {
			...
			create: function(oProps, oControlConfiguration, mSettings) {
				if (!oProps.selectionFields) {
					...
					var oSelectionFields = ListReportConverter.getSelectionFields(oConverterContext.getEntitySet(), [], oConverterContext);
				...
				if (
					oProps.entitySet.getObject("@com.sap.vocabularies.Common.v1.DraftRoot") ||
					oProps.entitySet.getObject("@com.sap.vocabularies.Common.v1.DraftNode")
				) {
