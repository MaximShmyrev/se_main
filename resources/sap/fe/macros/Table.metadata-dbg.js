...
sap.ui.define(
	...
	function(MacroMetadata, DataModelPathHelper, ConverterContext, MetaModelConverter, DataVisualization, TableConverter) {
		"use strict";
		...
		var Table = MacroMetadata.extend("sap.fe.macros.Table", {
			...
			create: function(oProps, oControlConfiguration, mSettings) {
				...
				if (oProps.tableDefinition === undefined || oProps.tableDefinition === null) {
					var oVisualizationObjectPath = MetaModelConverter.getInvolvedDataModelObjects(oProps.metaPath, oProps.contextPath);
					var oConverterContext = this.getConverterContext(oVisualizationObjectPath, oProps.contextPath, mSettings);

					var sVisualizationPath = DataModelPathHelper.getContextRelativeTargetObjectPath(oVisualizationObjectPath);
