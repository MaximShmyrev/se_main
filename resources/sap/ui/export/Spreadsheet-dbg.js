...
sap.ui.define([
	...
	function(jQuery, library, Core, ExportDialog, EventProvider, Device, SpreadsheetExport, Log, ExportUtils) {
		 ...
		 *          <li><code>version</code> (string) - Application version that creates the XLSX document (default: "1.86.3")</li>
			...
			return new Promise(function(fnResolve, fnReject) {
				...
				function onmessage(oMessage) {
					...
					if (oMessage.progress) {
						...
						oSpreadsheet.onprogress(oMessage.fetched, oMessage.total);
					}
					 ...
					 */
					if (oMessage.finished && oSpreadsheet.process !== null) {
