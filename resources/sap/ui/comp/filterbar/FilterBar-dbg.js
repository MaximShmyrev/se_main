...
sap.ui.define([
	'sap/ui/core/library', 'sap/m/Button', 'sap/m/Label', 'sap/m/Panel',  'sap/m/Text', 'sap/m/Toolbar', 'sap/m/ToolbarSpacer', 'sap/ui/Device', 'sap/ui/comp/state/UIState', './VariantConverterFrom', './VariantConverterTo',  'sap/ui/comp/smartvariants/PersonalizableInfo', 'sap/ui/comp/smartvariants/SmartVariantManagementUi2', 'sap/ui/core/InvisibleText', 'sap/ui/layout/Grid', 'sap/ui/layout/GridRenderer', 'sap/ui/layout/GridData', 'sap/ui/layout/HorizontalLayout', 'sap/ui/layout/VerticalLayout', 'sap/ui/layout/AlignedFlowLayout', 'sap/m/library', 'sap/ui/model/json/JSONModel', './FilterGroupItem', 'sap/base/Log', 'sap/base/util/merge', 'sap/ui/core/ShortcutHintsMixin'
], function(coreLib, Button,  Label,  Panel, Text, Toolbar, ToolbarSpacer, Device, UIState, VariantConverterFrom, VariantConverterTo, PersonalizableInfo, SmartVariantManagementUi2, InvisibleText, Grid, GridRenderer, GridData, HorizontalLayout, VerticalLayout, AlignedFlowLayout, mLibrary, JSONModel, FilterGroupItem, Log, merge, ShortcutHintsMixin) {
	"use strict";
	...
	var AriaHasPopup = coreLib.aria.HasPopup;
...
// };
	 ...
	 *
	 * @param {object} mCustomView the setting for the cutom view
...
//						}
						...
						oFilterPanel.switchView(sView ? sView : oFilterPanel.GROUP_KEY);
					}
					...
					P13nBuilder.createP13nDialog(oFilterPanel, {
						...
						this._oAdaptFiltersDialog.attachAfterClose(function() {
							...
							if (this._bOKFiltersDialogTriggered && this._bDirtyViaDialog && !this._bEnterPressedLeadsToSearch) {
...
// }
	...
	FilterBar.prototype._resetVariant = function() {
		...
		if (this._oVariantManagement && this._oVariantManagement.getVisible()) { // in case a variant is currently selected, re-apply this variant
