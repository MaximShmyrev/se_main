...
sap.ui.define([
	...
	TextArrangement.prototype.validateIDAndDescription = function(aValues, oSettings) {
		...
		if (!this.sDescription && aDescription[0]) {
	...
	TextArrangement.prototype.formatValue = function(aValues, sTargetType) {
		...
		if (!vDescription && this.sDescription || (this.sDescription && this.sDescription !== vDescription )) {
			vDescription = this.sDescription;
		} else if (!this.sDescription && vDescription ) {
			this.sDescription = vDescription;
		}
