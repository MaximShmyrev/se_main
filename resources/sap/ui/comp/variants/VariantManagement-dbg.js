...
// oRm.writeAccessibilityState(oControl, mAccProps);
	...
	VariantManagement.prototype.init = function() {
		...
		this.oVariantPopoverTrigger = new ToggleButton(this.getId() + "-trigger", {
			...
			press: function(oEvent) { this._oCtrlRef =  oEvent.getParameter("pressed") ?  this.oVariantPopoverTrigger : false; }.bind(this)
		});
...
//				}
			...
			// execute on select
			if (this.getDisplayTextForExecuteOnSelectionForStandardVariant && this.getDisplayTextForExecuteOnSelectionForStandardVariant() && oItems[iH].getKey() === this.getStandardVariantKey()) {
