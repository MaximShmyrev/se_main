sap.ui.define([
	...
	var controller = Controller.extend("main.controller.Examen", {
		...
		handleQuizPressed: function(oEvent) {
			...
			// get pressed value
			var testId = oEvent.oSource.mAggregations.attributes[0].mProperties.text;
			...
			sessionStorage.setItem("TEST", testId);
